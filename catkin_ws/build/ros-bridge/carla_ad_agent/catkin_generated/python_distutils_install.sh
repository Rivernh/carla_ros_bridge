...
echo_and_run cd "/home/ylh/carla-ros-bridge/catkin_ws/src/ros-bridge/carla_ad_agent"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3.6m" \
    "/home/ylh/carla-ros-bridge/catkin_ws/src/ros-bridge/carla_ad_agent/setup.py" \
     \
    build --build-base "/home/ylh/carla-ros-bridge/catkin_ws/build/ros-bridge/carla_ad_agent" \
    install \
    --root="${DESTDIR-/}" \
