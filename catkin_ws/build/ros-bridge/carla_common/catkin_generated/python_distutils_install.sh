...
echo_and_run cd "/home/ylh/carla-ros-bridge/catkin_ws/src/ros-bridge/carla_common"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3.6m" \
    "/home/ylh/carla-ros-bridge/catkin_ws/src/ros-bridge/carla_common/setup.py" \
     \
    build --build-base "/home/ylh/carla-ros-bridge/catkin_ws/build/ros-bridge/carla_common" \
    install \
    --root="${DESTDIR-/}" \
